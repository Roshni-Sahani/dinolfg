...
import AboutTree1 from "../assets/images/AboutTree1.webp";
import AboutTree2 from "../assets/images/AboutTree2.webp";
      ...
      >
        ...
        <div className="container xl:max-w-[1156px] relative z-[1] mx-auto xl:px-3 px-6">
          <div className=" flex flex-col justify-center items-center">
            <h2
              className="font-normal sm:text-[69.669px] text-[45px] ff-lucky drop-shadow-[0px_2.38px_0px_#FFF] leading-[100%] sm:mb-[42px] mb-[24px] text-center"
              data-aos="zoom-in"
            >
            ...
            <p
              className="text-white text-center sm:text-[24px] text-[18px] font-normal leading-[121%] mb-[18px] font-bal"
              data-aos="zoom-in"
            >
              $DINO is a meme coin with very strong utility.
            </p>
            <p
              className="text-white text-center sm:text-[24px] text-[18px] lg:max-w-[560px] leading-[127%] mb-[10px] font-bal"
              data-aos="zoom-in"
            >
            ...
            <p
              className="text-white text-center font-normal font-bal sm:text-[24px] text-[18px] lg:max-w-[560px] leading-[127%] mb-[14px]"
              data-aos="zoom-in"
            >
            ...
            <p
              className="text-white sm:text-[24px] text-[18px] font-bal font-normal lg:max-w-[599px] text-center leading-[121%] mb-[17px]"
              data-aos="zoom-in"
            >
